...
const projects = [
  ...
  {
    title: 'MizanKhata',
    description: 'A mobile-first personal and shop management app — a work timer and daily routine tracker (prayers, shop hours, health, repeating tasks) with a Google Calendar-style day view, plus a full Digikhata-style shop suite: Ledger, POS, Stock Book, Bill Book, Cash Book, and a multi-business dashboard.',
    tags: ['Next.js 16', 'TypeScript', 'Tailwind CSS', 'Supabase', 'PostgreSQL'],
    github: 'https://github.com/SanaAkram/MizanKhata',
    demo: null,
    image: 'https://images.pexels.com/photos/6802042/pexels-photo-6802042.jpeg?auto=compress&cs=tinysrgb&w=800',
    featured: false,
  },
  {
    title: 'Angrezi Safar — AI PTE Training',
    description: 'A real PTE Academic training platform built for the family — all 22 official PTE task types with authentic timers, AI-graded Speaking and Writing feedback, a self-growing question bank, a voice-input Urdu/English translator, grammar drills, a daily study plan, full mock tests, and a progress dashboard for observers.',
    tags: ['Next.js', 'TypeScript', 'Supabase', 'OpenAI', 'PostgreSQL'],
    github: 'https://github.com/SanaAkram/AI-PTE-Training',
    demo: 'https://ai-pte-training.vercel.app',
    image: 'https://images.pexels.com/photos/5905497/pexels-photo-5905497.jpeg?auto=compress&cs=tinysrgb&w=800',
    featured: false,
  },
  {

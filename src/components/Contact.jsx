...
const repoHighlights = [
  { name: 'ecommerce-platform', stars: 124, forks: 38, lang: 'TypeScript', langColor: '#3178c6' },
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
            <div className="glass-card rounded-xl p-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="font-semibold" style={{ color: 'var(--color-text-primary)' }}>@sumitgaikwad</span>
              </div>
